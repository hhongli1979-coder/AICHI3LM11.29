...
#### Jiagu 中文自然语言处理
平台集成 [Jiagu（甲骨）](https://gitee.com/ownthink/Jiagu) 深度学习自然语言处理工具，为中文文本分析提供强大支持：

- **中文分词** - 支持多种分词标准（MSR、PKU、CNC）和自定义词典
- **词性标注** - 为分词结果添加词性标签，支持语法分析
- **命名实体识别** - 识别人名、地名、组织机构等实体（BIO标注格式）
- **知识图谱关系抽取** - 从文本中提取三元组，构建语义知识图谱
- **情感分析** - 基于 BiLSTM 深度学习模型的情感倾向识别
- **关键词提取** - 自动提取文档中最重要的关键词
- **文本摘要** - 从长文本中生成简洁摘要
- **新词发现** - 利用信息熵和统计分析发现未登录词

这些 NLP 能力可用于交易描述分析、用户反馈处理和风险文本检测等场景。
