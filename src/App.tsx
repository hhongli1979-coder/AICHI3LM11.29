...
import { Bell, Wallet, ChartLine, CreditCard, ArrowsLeftRight, Coins, Gear, AddressBook as AddressBookIcon, Robot, Palette } from '@phosphor-icons/react';
...
import { CardDesignTemplate } from '@/components/card-design/CardDesignTemplate';
import {
  generateMockWallets,
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-5 lg:w-auto lg:inline-grid lg:grid-cols-10">
            ...
            <TabsTrigger value="card-design" className="gap-2">
              <Palette size={18} weight="duotone" />
              <span className="hidden sm:inline">卡片设计</span>
            </TabsTrigger>
          ...
          <TabsContent value="card-design" className="space-y-6">
            <CardDesignTemplate />
          </TabsContent>
