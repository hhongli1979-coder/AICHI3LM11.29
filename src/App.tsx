...
import { Bell, Wallet, ChartLine, CreditCard, ArrowsLeftRight, Coins, Gear, AddressBook as AddressBookIcon, Robot, Car } from '@phosphor-icons/react';
...
import { TaxidoBooking } from '@/components/taxido/TaxidoBooking';
import {
  generateMockWallets,
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-5 lg:w-auto lg:inline-grid lg:grid-cols-10">
            ...
            <TabsTrigger value="taxido" className="gap-2">
              <Car size={18} weight="duotone" />
              <span className="hidden sm:inline">Taxido</span>
            </TabsTrigger>
          ...
          <TabsContent value="taxido" className="space-y-6">
            <TaxidoBooking />
          </TabsContent>
