...
export function generateMockAIModelConfigs(): AIModelConfig[] {
  return [
    ...
    {
      id: 'model-3',
      name: 'MindSpore 深度学习引擎',
      provider: 'mindspore',
      modelName: 'mindspore-llm',
      apiEndpoint: 'http://localhost:8080/v1/generate',
      enabled: true,
      isDefault: false,
      maxTokens: 8192,
      temperature: 0.7,
      systemPrompt: '你是基于华为 MindSpore 深度学习框架的智能助手，专注于提供高效的 AI 推理服务，支持金融风控分析、交易模式识别和智能决策建议。',
